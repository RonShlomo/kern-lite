...
CPP_SRCS += \
../firmware/hal/exti.cpp \
../firmware/hal/tone.cpp 
...
firmware/hal/%.o firmware/hal/%.su firmware/hal/%.cyclo: ../firmware/hal/%.cpp firmware/hal/subdir.mk
...
clean: clean-firmware-2f-hal

clean-firmware-2f-hal:
	-$(RM) ./firmware/hal/exti.cyclo ./firmware/hal/exti.d ./firmware/hal/exti.o ./firmware/hal/exti.su ./firmware/hal/tone.cyclo ./firmware/hal/tone.d ./firmware/hal/tone.o ./firmware/hal/tone.su

.PHONY: clean-firmware-2f-hal
